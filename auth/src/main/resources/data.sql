...
VALUES ('clientId', '{bcrypt}$2a$10$vCXMWCn7fDZWOcLnIEhmK.74dvK1Eh8ae2WrWlhr2ETPLoxQctN4.', 'read,write', 'password,refresh_token,client_credentials,implicit', 'ROLE_CLIENT', 15000),
       ('clientIdTwo', '{bcrypt}$2a$10$vCXMWCn7fDZWOcLnIEhmK.74dvK1Eh8ae2WrWlhr2ETPLoxQctN4.', 'write', 'password,refresh_token,client_credentials,implicit', 'ROLE_CLIENT', 15000);
